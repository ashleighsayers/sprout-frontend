...
class EditProfileView {
  init(){
    ...
    document.title = 'Sprout | Edit Profile'    
    this.user = null
    this.render()    
    Utils.pageIntroAnim()
    this.getUser()    
  ...
  render(){
    const template = html`
      <va-app-header title="Edit Profile" user=${JSON.stringify(this.user)} levels=${JSON.stringify(this.levels)} currentLevel=${JSON.stringify(this.currentLevel)}></va-app-header>
